...
import { SmsPayButtonComponent } from './smsPayButton.component';

describe('SMS Pay button Component', () => {
    let sut: SmsPayButtonComponent;
    let fixture: ComponentFixture<SmsPayButtonComponent>;
    let de: DebugElement;
    ...
    beforeEach(() => {
        sut = new SmsPayButtonComponent(eRef,
            modalService,
