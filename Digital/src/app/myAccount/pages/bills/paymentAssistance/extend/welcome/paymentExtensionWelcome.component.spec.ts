...
import { PaymentExtensionWelcomeModule } from './paymentExtensionWelcome.module';

describe('Payment Extension Welcome', () => {

    let comp: PaymentExtensionWelcomeComponent;
    let fixture: ComponentFixture<PaymentExtensionWelcomeComponent>;

    let aglAuthTokenProvider: AglAuthTokenProvider;
    let configService: ConfigService;
    let router: Router;
    const anyCide: string = 'dummycide';
    const destinationRoute: string = '/bills/paymentassistance/extend/select';
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(PaymentExtensionWelcomeComponent);
    ...
    describe('Customer who is not logged into My Account', () => {
        ...
        it('should see the landing page for payment extension', () => {
            // ARRANGE
            // ACT
        ...
        describe('clicks the login button', () => {
            ...
            it('should redirect to the login page passing a redirect to the payment extension select page', () => {
                // ARRANGE
        ...
        describe('clicks the register button', () => {
            it('should redirect to the register page passing a redirect to the payment extension select page', () => {
                // ARRANGE
                const destinationUrl = destinationRoute + `?cide=${anyCide}`;
    ...
    describe('Customer who is logged into My Account', () => {
        ...
        it('should be redirected to the payment extension select page', () => {
            // ARRANGE
