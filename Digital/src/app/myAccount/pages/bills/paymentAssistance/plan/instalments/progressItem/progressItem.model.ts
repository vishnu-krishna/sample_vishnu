...
import { ProgressItem } from '../../../../../../maui/progressTracker/progressTracker.model';
import {  VerticalProgressItemModel, Color, LineStyle, BulletShape, BulletContent, PaneAlignment } from '../../../../../../maui/progressTracker/progressItems/verticalProgressItem/verticalProgressItem.model';

export class PaymentAssistancePlanInstalmentsProgressItem implements ProgressItem {
    ...
    public constructor(
        ...
        public readonly status: InstalmentStatus
    ) {}
    ...
    private isDueDateToday(): boolean {
        return this.dueDate ? moment(this.dueDate).isSame(moment(), 'day') : true;
    }
}
