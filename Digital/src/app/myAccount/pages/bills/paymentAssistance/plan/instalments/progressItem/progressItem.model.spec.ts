...
import { PaymentAssistancePlanInstalmentsProgressItem, InstalmentStatus } from './progressItem.model';
import { LineStyle, Color, BulletShape, BulletContent, PaneAlignment } from '../../../../../../maui/progressTracker/progressItems/verticalProgressItem/verticalProgressItem.model';

describe('instalment', () => {
    let instalmentProgressItem: PaymentAssistancePlanInstalmentsProgressItem;

    describe('When initialise is called', () => {
        it('should populate layout model', () => {
            instalmentProgressItem = new PaymentAssistancePlanInstalmentsProgressItem(0, null, InstalmentStatus.Paid);
        ...
        it('should populate left pane', () => {
            const amountDue = 10;
            instalmentProgressItem = new PaymentAssistancePlanInstalmentsProgressItem(amountDue, null, InstalmentStatus.Paid);
        ...
        it('should populate right pane', () => {
            ...
            instalmentProgressItem = new PaymentAssistancePlanInstalmentsProgressItem(0, dueDate, InstalmentStatus.Overdue);
