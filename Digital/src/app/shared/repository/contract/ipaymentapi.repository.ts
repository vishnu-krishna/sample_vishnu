...
export abstract class IPaymentApiRepository {
    ...
    public abstract post<T>(apiOptions: ApiModel.ApiRequestOptions): Observable<T>;
    public abstract postBody<T>(apiOptions: ApiModel.ApiRequestOptions): Observable<T>;
}
